...
[<assembly: AssemblyTitleAttribute("Khmer.Tests")>]
[<assembly: AssemblyProductAttribute("Khmer")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Khmer.Tests"
    let [<Literal>] AssemblyProduct = "Khmer"
